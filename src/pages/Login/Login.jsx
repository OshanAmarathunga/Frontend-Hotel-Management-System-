  ...
  return (
    <div className="w-full h-[100vh] bg-blue-600 pic-bg flex justify-center items-center">
      <div className="relative w-[700px] h-[400px] backdrop-blur-md rounded-lg flex flex-col items-center">
        ...
        <button
          onClick={handleLogin}
          className="absolute w-[70%] hover:bg-blue-900 bg-blue-500 text-white h-[40px] bottom-[70px]"
        >
          Login
        </button>
        <button className="absolute bottom-[20px] w-[70%] hover:bg-red-600 bg-red-500 h-[40px]">
          Register
        </button>
      </div>
    </div>
